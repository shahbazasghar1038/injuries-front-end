            ...
            <div className='card-bg'>
                <div className="flex flex-col form-width items-start gap-8 relative flex-[0_0_auto]">
                    ...
                    <div className="flex flex-col items-start gap-5 relative self-stretch w-full flex-[0_0_auto]">
                        ...
                        >
                            <div className={`flex w-12 items-center justify-around gap-2.5 p-3 relative rounded-xl overflow-hidden transition-colors duration-200 ${
                                selectedRole === 'doctor' ? 'bg-white' : 'bg-[#F2F4F7]'
                            }`}>
                            ...
                            <div className="flex items-end gap-5 relative flex-1 grow">
                                <div className="flex flex-col items-start gap-2 relative flex-1 grow">
                                    <h5 className={`relative self-stretch mt-[-1.00px] transition-colors duration-200 ${
                                        selectedRole === 'doctor' ? 'text-[#1D2939]' : 'text-[#667085]'
                                    }`}>
                                        Doctor
                                    </h5>
                                </div>
                        ...
                        >
                            <div className={`flex w-12 items-center justify-around gap-2.5 p-3 relative rounded-xl overflow-hidden transition-colors duration-200 ${
                                selectedRole === 'attorney' ? 'bg-white' : 'bg-[#F2F4F7]'
                            }`}>
                            ...
                            <div className="flex items-end gap-5 relative flex-1 grow">
                                <div className="flex flex-col items-start gap-2 relative flex-1 grow">
                                    <h5 className={`relative self-stretch mt-[-1.00px] transition-colors duration-200 ${
                                        selectedRole === 'attorney' ? 'text-[#1D2939]' : 'text-[#667085]'
                                    }`}>
                                        Attorney
                                    </h5>
                                </div>
