    ...
    >
      <div className="rounded-xl bg-[#F9FAFB] p-3 ">
        ...
        <div className="space-y-3 text-sm">
          ...
          <div className="flex">
            <span className="fs-14 fw-400 text-blue-85 w-32">
              Date of Accident:
            </span>
            <span className="fs-14 fw-500 text-gray-54">
          ...
          <div className="flex">
            ...
            <span className="fs-14 fw-500 text-gray-54">
              {formatDate(caseItem.caseStartData)}
            </span>
          </div>
          ...
          <div className="flex items-center">
            ...
            <span
              className={`px-2 py-0.5 rounded-md fs-14 fw-500 ${caseItem.statusColor}`}
            >
              {caseItem.status}
            </span>
          </div>
